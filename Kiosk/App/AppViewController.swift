...
class AppViewController: UIViewController, UINavigationControllerDelegate {
    ...
    var sale = Variable(Sale(id: "", name: "", isAuction: true, startDate: Date(), endDate: Date(), artworkCount: 0, state: "", bypassCreditCardRequirement: true)) // ⚠️ TODO: set bypassCreditCardRequirement to false before merging
